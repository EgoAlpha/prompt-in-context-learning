...
[**Are Chatbots Ready for Privacy-Sensitive Applications? An Investigation into Input Regurgitation and Prompt-Induced Sanitization**](https://arxiv.org/abs/2305.15008) （**2023.05.24**）

<font color="gray">Aman Priyanshu, Supriti Vijay, Ayush Kumar, Rakshit Naidu, Fatemehsadat Mireshghallah </font>
...
[**RefGPT: Reference ->Truthful&Customized Dialogues Generation by GPTs and for GPTs**](https://arxiv.org/abs/2305.14994) （**2023.05.24**）

<font color="gray">Dongjie Yang, Ruifeng Yuan, YuanTao Fan, YiFei Yang, Zili Wang, etc </font>

![](https://img.shields.io/badge/Citations-0-green)  [![](https://img.shields.io/badge/Github%20Stars-98-blue)](https://github.com/ziliwangnlp/refgpt)
...
[**How Predictable Are Large Language Model Capabilities? A Case Study on BIG-bench**](https://arxiv.org/abs/2305.14947) （**2023.05.24**）

<font color="gray">Qinyuan Ye, Harvey Yiyun Fu, Xiang Ren, Robin Jia </font>
...
[**PaCE: Unified Multi-modal Dialogue Pre-training with Progressive and Compositional Experts**](https://arxiv.org/abs/2305.14839) （**2023.05.24**）

<font color="gray">Yunshui Li, Binyuan Hui, ZhiChao Yin, Min Yang, Fei Huang, etc </font>
...
[**Instruction Tuning with Lexicons for Zero-Shot Style Classification**](https://arxiv.org/abs/2305.14592) （**2023.05.24**）

<font color="gray">Ruohao Guo, Wei Xu, Alan Ritter </font>
...
[**Memory-Efficient Fine-Tuning of Compressed Large Language Models via sub-4-bit Integer Quantization**](https://arxiv.org/abs/2305.14152) （**2023.05.23**）

<font color="gray">Jeonghoon Kim, Jung Hyun Lee, Sungdong Kim, Joonsuk Park, Kang Min Yoo, etc </font>
...
[**Parameter-Efficient Language Model Tuning with Active Learning in Low-Resource Settings**](https://arxiv.org/abs/2305.14576) （**2023.05.23**）
...
[**FOCUS: Effective Embedding Initialization for Specializing Pretrained Multilingual Models on a Single Language**](https://arxiv.org/abs/2305.14481) （**2023.05.23**）
...
[**Beyond Shared Vocabulary: Increasing Representational Word Similarities across Languages for Multilingual Machine Translation**](https://arxiv.org/abs/2305.14189) （**2023.05.23**）

<font color="gray">Di Wu, Christof Monz </font>

![](https://img.shields.io/badge/Citations-0-green)

---

[**Control of a simulated MRI scanner with deep reinforcement learning**](https://arxiv.org/abs/2305.13979) （**2023.05.23**）
...
[**MemeCap: A Dataset for Captioning and Interpreting Memes**](https://arxiv.org/abs/2305.13703) （**2023.05.23**）
...
[**Eliminating Spurious Correlations from Pre-trained Models via Data Mixing**](https://arxiv.org/abs/2305.14521) （**2023.05.23**）
...
[**Linear Cross-Lingual Mapping of Sentence Embeddings**](https://arxiv.org/abs/2305.14256) （**2023.05.23**）
...
[**Multi-Granularity Prompts for Topic Shift Detection in Dialogue**](https://arxiv.org/abs/2305.14006) （**2023.05.23**）
...
[**Pre-training Multi-task Contrastive Learning Models for Scientific Literature Understanding**](https://arxiv.org/abs/2305.14232) （**2023.05.23**）
...
[**ManiTweet: A New Benchmark for Identifying Manipulation of News on Social Media**](https://arxiv.org/abs/2305.14225) （**2023.05.23**）
...
[**Revealing User Familiarity Bias in Task-Oriented Dialogue via Interactive Evaluation**](https://arxiv.org/abs/2305.13857) （**2023.05.23**）
...
[**Towards Asking Clarification Questions for Information Seeking on Task-Oriented Dialogues**](https://arxiv.org/abs/2305.13690) （**2023.05.23**）
...
[**Error Detection for Text-to-SQL Semantic Parsing**](https://arxiv.org/abs/2305.13683) （**2023.05.23**）
...
[**UNIMO-3: Multi-granularity Interaction for Vision-Language Representation Learning**](https://arxiv.org/abs/2305.13697) （**2023.05.23**）
...
[**Mitigating Language Model Hallucination with Interactive Question-Knowledge Alignment**](https://arxiv.org/abs/2305.13669) （**2023.05.23**）
...
[**LLM-grounded Diffusion: Enhancing Prompt Understanding of Text-to-Image Diffusion Models with Large Language Models**](https://arxiv.org/abs/2305.13655) （**2023.05.23**）
...
[**Interpreting Transformer's Attention Dynamic Memory and Visualizing the Semantic Information Flow of GPT**](https://arxiv.org/abs/2305.13417) （**2023.05.22**）
...
[**Let GPT be a Math Tutor: Teaching Math Word Problem Solvers with Customized Exercise Generation**](https://arxiv.org/abs/2305.14386) （**2023.05.22**）
...
[**Connecting Multi-modal Contrastive Representations**](https://arxiv.org/abs/2305.14381) （**2023.05.22**）
...
[**Improving Classifier Robustness through Active Generation of Pairwise Counterfactuals**](https://arxiv.org/abs/2305.13535) （**2023.05.22**）
...
[**If at First You Don't Succeed, Try, Try Again: Faithful Diffusion-based Text-to-Image Generation by Selection**](https://arxiv.org/abs/2305.13308) （**2023.05.22**）
...
[**SCITAB: A Challenging Benchmark for Compositional Reasoning and Claim Verification on Scientific Tables**](https://arxiv.org/abs/2305.13186) （**2023.05.22**）
...
[**Lion: Adversarial Distillation of Closed-Source Large Language Model**](https://arxiv.org/abs/2305.12870) （**2023.05.22**）
...
[**Interactive Data Synthesis for Systematic Vision Adaptation via LLMs-AIGCs Collaboration**](https://arxiv.org/abs/2305.12799) （**2023.05.22**）
...
[**Mitigating Data Imbalance and Representation Degeneration in Multilingual Machine Translation**](https://arxiv.org/abs/2305.12786) （**2023.05.22**）
...
[**This Prompt is Measuring: Evaluating Bias Evaluation in Language Models**](https://arxiv.org/abs/2305.12757) （**2023.05.22**）
...
[**G3Detector: General GPT-Generated Text Detector**](https://arxiv.org/abs/2305.12680) （**2023.05.22**）
...
[**Communication Efficient Federated Learning for Multilingual Neural Machine Translation with Adapter**](https://arxiv.org/abs/2305.12449) （**2023.05.21**）
...
[**WOT-Class: Weakly Supervised Open-world Text Classification**](https://arxiv.org/abs/2305.12401) （**2023.05.21**）
...
[**Collaborative Development of NLP models**](https://arxiv.org/abs/2305.12219) （**2023.05.20**）
...
[**Joint Foundation Model Caching and Inference of Generative AI Services for Edge Intelligence**](https://arxiv.org/abs/2305.12130) （**2023.05.20**）
...
[**DiffCap: Exploring Continuous Diffusion on Image Captioning**](https://arxiv.org/abs/2305.12144) （**2023.05.20**）
...
[**Enhancing Vision-Language Pre-Training with Jointly Learned Questioner and Dense Captioner**](https://doi.org/10.48550/arXiv.2305.11769) （**2023.05.19**）

<font color="gray">Zikang Liu, Sihan Chen, Longteng Guo, Handong Li, Xingjian He, etc .  - 【arXiv.org】</font>

![](https://img.shields.io/badge/Citations-0-green)

---

[**Plug-and-Play Medical Dialogue System**](https://doi.org/10.48550/arXiv.2305.11508) （**2023.05.19**）

<font color="gray">Chengfeng Dou, Zhi Jin, Wenping Jiao, Haiyan Zhao, Zhenwei Tao, etc .  - 【arXiv.org】</font>

![](https://img.shields.io/badge/Citations-0-green)

---

[**The Inside Story: Towards Better Understanding of Machine Translation Neural Evaluation Metrics**](https://doi.org/10.48550/arXiv.2305.11806) （**2023.05.19**）

<font color="gray">Ricardo Rei, Nuno M. Guerreiro, Marcos Vinícius Treviso, Luísa Coheur, A. Lavie, etc .  - 【arXiv.org】</font>
...
[**HalOmi: A Manually Annotated Benchmark for Multilingual Hallucination and Omission Detection in Machine Translation**](https://doi.org/10.48550/arXiv.2305.11746) （**2023.05.19**）

<font color="gray">David Dale, Elena Voita, Janice Lam, Prangthip Hansanti, Christophe Ropers, etc .  - 【arXiv.org】</font>

![](https://img.shields.io/badge/Citations-0-green)

---

[**What Comes Next? Evaluating Uncertainty in Neural Text Generators Against Human Production Variability**](https://doi.org/10.48550/arXiv.2305.11707) （**2023.05.19**）

<font color="gray">Mario Giulianelli, Joris Baan, Wilker Aziz, Raquel Fern'andez, Barbara Plank .  - 【arXiv.org】</font>
...
[**Support for Stock Trend Prediction Using Transformers and Sentiment Analysis**](https://arxiv.org/abs/2305.14368) （**2023.05.18**）
...
[**ONE-PEACE: Exploring One General Representation Model Toward Unlimited Modalities**](https://doi.org/10.48550/arXiv.2305.11172) （**2023.05.18**）

<font color="gray">Peng Wang, Shijie Wang, Junyang Lin, Shuai Bai, Xiaohuan Zhou, etc .  - 【arXiv.org】</font>
...
[**UniControl: A Unified Diffusion Model for Controllable Visual Generation In the Wild**](https://doi.org/10.48550/arXiv.2305.11147) （**2023.05.18**）

<font color="gray">Can Qin, Shu Zhang, Ning Yu, Yihao Feng, Xinyi Yang, etc .  - 【arXiv.org】</font>

![](https://img.shields.io/badge/Citations-0-green)

---

[**LLMScore: Unveiling the Power of Large Language Models in Text-to-Image Synthesis Evaluation**](https://doi.org/10.48550/arXiv.2305.11116) （**2023.05.18**）

<font color="gray">Yujie Lu, Xianjun Yang, Xiujun Li, X. Wang, William Yang Wang .  - 【arXiv.org】</font>
...
[**Comparing Biases and the Impact of Multilingual Training across Multiple Languages**](https://doi.org/10.48550/arXiv.2305.11242) （**2023.05.18**）

<font color="gray">Sharon Levy, Neha Ann John, Ling Liu, Yogarshi Vyas, Jie Ma, etc .  - 【arXiv.org】</font>

![](https://img.shields.io/badge/Citations-0-green)

---

[**Paxion: Patching Action Knowledge in Video-Language Foundation Models**](https://doi.org/10.48550/arXiv.2305.10683) （**2023.05.18**）

<font color="gray">Zhenhailong Wang, Ansel Blume, Sha Li, Genglin Liu, Jaemin Cho, etc .  - 【arXiv.org】</font>
...
[**Vision-Language Pre-training with Object Contrastive Learning for 3D Scene Understanding**](https://doi.org/10.48550/arXiv.2305.10714) （**2023.05.18**）

<font color="gray">Zhang Tao, Su He, D. Tao, Bin Chen, Zhi Wang, etc .  - 【arXiv.org】</font>

![](https://img.shields.io/badge/Citations-0-green)

---

[**Listen, Think, and Understand**](https://doi.org/10.48550/arXiv.2305.10790) （**2023.05.18**）

<font color="gray">Yuan Gong, Hongyin Luo, Alexander H. Liu, Leonid Karlinsky, James Glass .  - 【arXiv.org】</font>
...
[**IMAD: IMage-Augmented multi-modal Dialogue**](https://arxiv.org/abs/2305.10512) （**2023.05.17**）
...
[**Incorporating Attribution Importance for Improving Faithfulness Metrics**](https://doi.org/10.48550/arXiv.2305.10496) （**2023.05.17**）

<font color="gray">Zhixue Zhao, Nikolaos Aletras .  - 【arXiv.org】</font>
...
[**Sequence-to-Sequence Pre-training with Unified Modality Masking for Visual Document Understanding**](https://doi.org/10.48550/arXiv.2305.10448) （**2023.05.16**）

<font color="gray">ShuWei Feng, Tianyang Zhan, Zhanming Jie, Trung Quoc Luong, Xiaoran Jin .  - 【arXiv.org】</font>

![](https://img.shields.io/badge/Citations-0-green)

---

[**Learning the Visualness of Text Using Large Vision-Language Models**](https://doi.org/10.48550/arXiv.2305.10434) （**2023.05.11**）

<font color="gray">Gaurav Verma, Ryan A. Rossi, Chris Tensmeyer, Jiuxiang Gu, A. Nenkova .  - 【arXiv.org】</font>
