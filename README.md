...
__PAPER_LIST__:{field:"Prompt Design",size:9999}

### 📌 Automatic Prompt 

__PAPER_LIST__:{field:"Automatic Prompt",size:9999}

### 📌 Chain of Thought

__PAPER_LIST__:{field:"chain of thought",size:9999}

### 📌 Evaluation & Reliability

__PAPER_LIST__:{field:"Evaluation and Reliability",size:9999}

## In-context Learning

__PAPER_LIST__:{field:"In context learning",size:9999}

## Multimodal Prompt

### 📌 Hard Prompt/ Discrete Prompt

__PAPER_LIST__:{field:"Multimodal Hard Prompt",size:9999}

### 📌 Soft Prompt/ Continuous Prompt

__PAPER_LIST__:{field:"Multimodal Soft Prompt",size:9999}
