...
<!--  <div align="center">
 ...
 [![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=30&duration=2500&pause=500&color=6AF755&background=FCFCFF00&center=true&vCenter=true&width=500&lines=Hello!+Human%2C+Are+You+Ready%3F;Welcome+to+my+world!)](https://git.io/typing-svg)
...
__PAPER_LIST__:{field:'Automatic Prompt',size:10,state:'corrected'}

👉[Complete paper list 🔗 for "Automatic Prompt"](./PaperList/AutomaticPromptList.md)👈

### 📌 Chain of Thought

__PAPER_LIST__:{field:'chain of thought',size:10,state:'corrected'}

👉[Complete paper list 🔗 for "Chain of Thought"](./PaperList/ChainofThoughtList.md)👈

### 📌 Evaluation & Reliability

__PAPER_LIST__:{field:'Evaluation and Reliability',size:10,state:'corrected'}

👉[Complete paper list 🔗 for "Evaluation & Reliability"](./PaperList/EvaluationReliabilityList.md)👈

## In-context Learning

__PAPER_LIST__:{field:'In context learning',size:10,state:'corrected'}
...
__PAPER_LIST__:{field:'Multimodal Hard Prompt',size:10,state:'corrected'}

👉[Complete paper list 🔗 for "Hard Prompt"](./PaperList/HardPromptList.md)👈

### 📌 Soft Prompt/ Continuous Prompt

__PAPER_LIST__:{field:'Multimodal Soft Prompt',size:10,state:'corrected'}
